...
export declare function inFunctionContext(config: Config, path: string, callback: (app: App, ourFunction: ExtensionInstance<FunctionConfigType>) => Promise<void>): Promise<void>;
