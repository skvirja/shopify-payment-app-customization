...
export declare function setupConfigWatcher({ extension, token, apiKey, registrationId, stdout, stderr, signal, specifications, unifiedDeployment, }: SetupConfigWatcherOptions): Promise<void>;
