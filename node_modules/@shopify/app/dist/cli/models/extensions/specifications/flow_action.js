...
import { validateNonCommerceObjectShape, startsWithHttps, validateCustomConfigurationPageConfig, } from '../../../services/flow/validation.js';
...
const FlowActionExtensionSchema = BaseSchema.extend({
    ...
    return validateCustomConfigurationPageConfig(extension.config_page_url, extension.config_page_preview_url, extension.validation_url);
});
/**
